# LLM Prompt
## CONTEXT
This is a widget project named 'invoice-widget' that the user described in the following: "Display a table of QBO invoices filtered by ItemRef.value (2, 10, 38, 11), showing CustomerRef.name and last line Amount, with invoice click expanding to show line details and a global filter, styled with Tailwind.".
...
– FileMaker file: CleanSweep.fmp12
